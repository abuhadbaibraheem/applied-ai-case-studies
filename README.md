...
I am **Ibraheem Abuhadba**, an AI engineer in Amman, Jordan. These short case studies show how I think about AI as part of a working product: conversation design, structured data, validation, and the hand-off to real users and services.
...
- Whether the system solves the user's task across a full conversation, not just on a single prompt.
- Where a model can be uncertain, invent information, or miss a required detail.
- How the AI component connects to backend validation, APIs, and the mobile experience.
- How to test real failure cases and recover clearly.
